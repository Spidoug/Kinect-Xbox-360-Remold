...
The V1 source release does not depend on committed generated JARs. Processing/JOGL/GlueGen are bootstrapped as pinned, SHA-256-verified build dependencies when `applications/binaries/` is absent.
