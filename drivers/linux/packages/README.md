...
V1 firmware policy: packages do not download non-V1 Kinect SDK firmware payloads. Supply Microsoft Kinect Runtime 1.8 UACFirmware 01.02.709.00 through the source firmware input or `KINECT_UAC_FIRMWARE`; camera/depth installation remains independent when audio firmware is absent.
