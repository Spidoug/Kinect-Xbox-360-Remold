...
The Linux runtime implements the Kinect USB camera protocol directly and links only to its declared system dependencies.
...
The build compiles current source and stages generated output under `drivers/linux/dist/<architecture>/`. That output is generated locally and is not committed to the repository.
