...
- Scanner Port v1 exposes reconnectable RGB + calibrated metric Depth sessions to the **3D Scanner** tab in `SynKinectStudio`; stale Processing clients are detected by pipe state plus client PID.
