@{
    ...
    Dependencies = @{
        ...
        KinectUacFirmware = @{
            ...
            FirmwareSha256 = '4467ae36ad378c58477432729d74eed0f9d45d35213f4430a781d90f64cea3f9'
    ...
    # Canonical V1 UAC microphone endpoint.  Both Xbox 360 revisions are driven
    # to this post-firmware stream contract; the 1473 keeps its separate MI_00
    # control topology.  Do not regress to the raw 02AD bInterval=5 endpoint,
    # which Windows cannot schedule as a high-speed isochronous pipe.
    KinectUacIsoInEndpoint = 0x82
    KinectUacIsoInAttributes = 0x0D
    KinectUacIsoInMaxPacketBytes = 524
    KinectUacIsoInBInterval = 4
    KinectUacSampleRate = 16000
    KinectUacChannels = 4
    KinectUacBitsPerSample = 32
