@{
    ...
    # UACFirmware 01.02.709.00 constructs its descriptors at runtime and already
    # emits Audio ISO IN bInterval 4 (8 microframes). The build verifies the
    # complete image hash rather than mutating executable instructions.
