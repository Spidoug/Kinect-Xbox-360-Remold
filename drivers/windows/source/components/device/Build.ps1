...
try{
    ...
    Write-Host ("UACFirmware {0} validation: PASS (raw image, bytes={1}, load=0x00080000, entry=0x00080030; models=1414,1473)" -f $expectedFirmwareVersion,$fw.Length) -ForegroundColor Green
