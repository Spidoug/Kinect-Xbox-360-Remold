...
`drivers/windows/binaries/` is a generated publication directory created by `drivers/windows/BUILD.cmd`. It is generated locally and is not committed to the repository.
...
4. Verify Install / Reinstall on Windows 11 x64.
