...
- Documentation screenshots are not application runtime assets; they belong under [`../docs/images/`](../docs/images/) and are cataloged in [`../docs/images/README.md`](../docs/images/README.md).
