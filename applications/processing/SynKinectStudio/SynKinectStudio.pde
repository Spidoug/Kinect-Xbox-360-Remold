...
void initializeStudioTypography(){
  ...
  studioUnicodeRegular=createFont("SansSerif",15,true);
  studioUnicodeHeading=createFont("SansSerif",27,true);
...
float studioUiScale(){
  ...
  // The old 0.90 floor made controls overflow instead of shrinking.
