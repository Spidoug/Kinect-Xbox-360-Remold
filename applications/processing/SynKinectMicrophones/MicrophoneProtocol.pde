class MicrophoneProtocol {
  static final String PIPE="\\\\.\\pipe\\Kinect360RemoldAudio";
  static final String FALLBACK_PIPE="\\\\.\\pipe\\Kinect360RemoldAcoustic";
  static final String SOCKET="/run/kinect360-remold/audio.sock";
  static final String FALLBACK_SOCKET="/run/kinect360-remold/acoustic.sock";
